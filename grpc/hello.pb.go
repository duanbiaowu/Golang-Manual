...
var file_hello_proto_rawDesc = []byte{
	...
	,
...
var file_hello_proto_goTypes = []interface{}{
	(*String)(nil), // 0: grpc.String
}
var file_hello_proto_depIdxs = []int32{
	0, // 0: grpc.HelloService.Hello:input_type -> grpc.String
	0, // 1: grpc.HelloService.Channel:input_type -> grpc.String
	0, // 2: grpc.HelloService.Hello:output_type -> grpc.String
	0, // 3: grpc.HelloService.Channel:output_type -> grpc.String
...
func (c *helloServiceClient) Hello(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/grpc.HelloService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[0], "/grpc.HelloService/Channel", opts...)
	if err != nil {
		return nil, err
	}
...
func _HelloService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.HelloService/Hello",
	}
